...
--2.which customers used a discount but still spent more than the aveg purchase amount?
select customer_id, purchase_amount
from customer 
where discount_applied = 'Yes' and purchase_amount >=(select AVG(purchase_amount) from customer)

--3.what are the top 5 products with thw highest average review rating?
select item_purchased, ROUND(avg(review_rating::numeric),2) as "Average Purchase Rating"
from customer
